...
if (isset($pub_sub_action) && $pub_sub_action == "send" )
{
    ...
    if (file_exists(MOD_ROOT_MODEL."model_".$pub_type.".php")) { include(MOD_ROOT_MODEL."model_".$pub_type.".php"); }
    elseif (isset($temp_ally[$pub_type])){ include(MOD_ROOT_MODEL."model_CST_ALLIANCES_RANK.php");  }
    elseif (isset($temp_player[$pub_type])){ include(MOD_ROOT_MODEL."model_CST_PLAYERS_RANK.php");  }
    elseif ( strstr($pub_type, "CST_UNIVERSE")) {include(MOD_ROOT_MODEL."model_CST_UNIVERSE.php");  }
    else
    {
